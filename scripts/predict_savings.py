...
# This module estimates your yearly savings using data from monthly CSV reports.
# It scans for savings entries, calculates an average, and projects your annual total.
